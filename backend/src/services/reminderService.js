...
module.exports = class ReminderService {
  ...
  /**
   * Destroy all reminders with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds reminders for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds reminders based on the query.
   *
   * @param {*} args
   */

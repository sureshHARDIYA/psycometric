const QuestionnaireRepository = require('../database/repositories/questionnaireRepository');
 ...
 */
module.exports = class QuestionnaireService {
  ...
  async changeFavourites(id, data) {
    const session = await MongooseRepository.createSession();

    try {
      const record = await this.repository.updateFavourites(
        id,
        data,
        {
          session,

...
import selectors from 'modules/reminder/selector';

class ReminderAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return ReminderService.listAutocomplete(value, limit);
  };

...
const actions = {
  ...
  AUTH_CHANGPASSWORD_START: `${prefix}_AUTH_CHANGPASSWORD_START`,
  AUTH_CHANGPASSWORD_SUCCESS: `${prefix}_AUTH_CHANGPASSWORD_SUCCESS`,
  AUTH_CHANGPASSWORD_ERROR: `${prefix}_AUTH_CHANGPASSWORD_ERROR`,
  ...
  doChangePassword: (
    ...
    try {
      ...
      AuthToken.set(token, !!localStorage.getItem('jwt'));
      dispatch({
        payload: token,
        type: actions.AUTH_CHANGPASSWORD_SUCCESS,
      });
    } catch (error) {
      dispatch({
        type: actions.AUTH_CHANGPASSWORD_ERROR,
        payload: Errors.selectMessage(error),
      });
    }
  },

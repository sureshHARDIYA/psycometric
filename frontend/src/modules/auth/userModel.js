...
import ShapeObjectField from 'modules/shared/fields/shapeObjectField';
...
const fields = {
  ...
  intrestedCategories: new RelationToManyField(
    'intrestedCategories',
    label('intrestedCategories'),
    {},
  ),
  ...
  settings: new ShapeObjectField(
    'settings',
    label('settings'),
    {
      newQuestionnaireAlert: new BooleanField(
        'settings.newQuestionnaireAlert',
        label('newQuestionnaireAlert'),
      ),
      remindersAlert: new BooleanField(
        'settings.remindersAlert',
        label('remindersAlert'),
      ),
    },
    {},
  ),

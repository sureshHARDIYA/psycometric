...
import QuizRecordService from 'modules/quizRecord/QuizRecordService';
import selectors from 'modules/quizRecord/list/QuizRecordListSelectors';
import exporterFields from 'modules/quizRecord/list/QuizRecordListExporterFields';

const prefix = 'QUIZRECORD_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await QuizRecordService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.quesionnaire.exporterFileName'),
